    ...
    <>
      <div className=" mt-10 mb-10" >
        ...
        <div className=" mt-5">
          ...
          <img src='https://zxtodmdglvcilqtuxipr.supabase.co/storage/v1/object/public/SS_Image/About/aboutMobile/CompanyImage.png' alt="" className=" w-[31%] md:w-[15%]"/>
        ...
        <div className="flex justify-center mt-5">
            <img src='https://zxtodmdglvcilqtuxipr.supabase.co/storage/v1/object/public/SS_Image/About/Link.svg' alt="" data-aos="fade-down" data-aos-duration="1000"/>
        </div>
        <div>
        <div className=" flex items-center justify-center mt-10">
           ...
           <img src='https://zxtodmdglvcilqtuxipr.supabase.co/storage/v1/object/public/SS_Image/About/aboutMobile/FactoryImage.png' alt="" className=" w-[31%] md:w-[15%] md:ml-10" data-aos="fade-right" data-aos-duration="1000"/>
